...
import static scenario.ScenarioManager.scenarioName;
...
public class ReportManager{
    ...
    static {
        ...
        pathToSave = Paths.get(Paths.get("").toAbsolutePath().toString() + File.separator +
                "target" + File.separator + "Evidences" + File.separator + "Execucao_" + formatDate("dd_MM_yyyy_HH-mm", new Date()) + File.separator);
        try {
    ...
    public static void addEvidence(Path path, boolean copyFile) {
        String testName = scenarioName.getName();
        Path fullPath = Paths.get(pathToSave + File.separator + path.getFileName());
